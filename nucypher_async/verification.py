...
class PublicUrsula(PeerInfo):
    ...
    @classmethod
    def checked_remote(cls, clock: BaseClock, peer_info: PeerInfo, received_from: SecureContact,
            operator_address: IdentityAddress, domain: Domain) -> "PublicUrsula":
    ...
    @classmethod
    def checked_local(cls, clock: BaseClock, peer_info: PeerInfo, ursula: Ursula,
